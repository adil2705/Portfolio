...
const HomeInfo = () => {
  ...
  return (
    <section className="max-container pb-5">
      ...
      <div className="mt-5 font-semibold backdrop-blur-[2px] rounded-lg text-2xl lg:text-4xl text-blue-800">
        <span>
      ...
      <div className="mt-5">
        <a
          href="https://drive.google.com/file/d/1Ge0co07k-gkKd5Y5WqfRWQOkZ1CCqnWD/view?usp=drivesdk"
          target="_blank"
          rel="noreferrer"
        >
